...
public class CommandProcessorTest {
	...
	@Test
	void passtime_reduces_the_amount_of_balance_by_25_if_it_is_less_than_100() {
		commandProcessor.process("deposit 11111111 99");
		commandProcessor.process("deposit 22222222 100");
		commandProcessor.process("pass 1");

		double actual = bank.retrieveAccount(11111111).getBalance();
		assertEquals(74.074, actual);

		double actual1 = bank.retrieveAccount(22222222).getBalance();
		assertEquals(100.1, actual1);
	}
